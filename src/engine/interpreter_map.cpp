...
#include "scenes/equip.h"
#include "scenes/item.h"
#include "scenes/menu.h"
#include "scenes/order.h"
#include "scenes/save.h"
#include "scenes/status.h"
#include "scenes/skill.h"
#include "scenes/load.h"
#include "scenes/name.h"
...
bool Game_Interpreter_Map::CommandRecallToLocation(lcf::rpg::EventCommand const& com) { // Code 10830
	...
	Main_Data::game_hero->ReserveTeleport(map_id, x, y, -1, tt);
...
bool Game_Interpreter_Map::CommandTeleport(lcf::rpg::EventCommand const& com) { // Code 10810
	...
	Main_Data::game_hero->ReserveTeleport(map_id, x, y, direction, tt);
...
bool Game_Interpreter_Map::CommandEnterExitVehicle(lcf::rpg::EventCommand const& /* com */) { // code 10840
	Main_Data::game_hero->GetOnOffVehicle();
